...
public class SectionRecyclerViewAdapter extends RecyclerView.Adapter<SectionRecyclerViewAdapter.ViewHolder> {
    ...
    public SectionRecyclerViewAdapter(List<Article> items, HomeFragment.OnListFragmentInteractionListener listener,
...
//                    }
    ...
    public void swapItems(ArrayList<Article> items){
        mValues.clear();
